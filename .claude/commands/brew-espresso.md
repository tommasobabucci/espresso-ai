...
Launches all 8 research collection pipelines simultaneously: ArXiv, Perplexity, X/Apify, X/Claude, X/Perplexity, Reddit/Claude, Reddit/Perplexity, and Influencer (~71 people). Skips collectors whose API keys are not configured. Presents a unified summary when complete.
